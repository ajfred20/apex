      ...
      <div className="container px-4 md:px-6 mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-medium tracking-tighter text-white">
            ...
            <span className="block md:inline">
              hear from our <span className="text-orange-500">Partners</span>
            </span>
          </h2>
        </div>
        ...
        <div className="relative max-w-5xl mx-auto">
          <div className="flex justify-center gap-4 md:gap-6">
            ...
            <div className="hidden md:block w-full max-w-sm rounded-xl bg-zinc-900/80 p-6 opacity-70">
            ...
            <div className="w-full max-w-sm md:max-w-md rounded-xl bg-white p-6 shadow-lg">
              <div className="mb-6 h-12 flex items-center">
